...
| Scenario | Link |
|----------|------|
| Personal site / portfolio | [usage.md §7.1](docs/usage.md#71-personal-developer--seo-friendly-personal-site) |
| Product website — SEO growth | [usage.md §7.2](docs/usage.md#72-product-website--seo-growth-with-frontend--ops-split) |
| Learn SEO standalone | [usage.md §7.3](docs/usage.md#73-vibe-coding-beginner--learn-seo-standalone) |
| Vibe coding product — built-in skills | [usage.md §7.4](docs/usage.md#74-vibe-coding-product--built-in-skills-as-templates) |
| Build your own skills | [usage.md §7.5](docs/usage.md#75-want-to-build-your-own-skills--fork--adapt) |
...
**Start with**: Overview, 1–4, 8. Add 5–7 as you have them. Update regularly — stale context degrades quality. [Templates](templates/README.md) · [skill-authoring §8](docs/skill-authoring.md#8-customization)
