...
Complete skill list, page taxonomy, and dependency maps. See [README](../README.md) for overview.
...
| [indexing](../skills/seo/technical/indexing/) | Fix indexing issues, noindex page-type list, Search Console |
...
| [core-web-vitals](../skills/seo/technical/core-web-vitals/) | LCP, INP, CLS optimization; page speed; Page Experience |
| [mobile-friendly](../skills/seo/technical/mobile-friendly/) | Mobile-first indexing; mobile usability; viewport, touch targets |
| [rendering-strategies](../skills/seo/technical/rendering-strategies/) | SSR, SSG, CSR, ISR; static/dynamic rendering; content in initial HTML; crawler visibility |
...
#### Off-Page, Content, Local, Tactics
...
| [entity-seo](../skills/seo/entity-seo/) | Entity SEO: Knowledge Graph, Organization/Person schema, entity signals, Knowledge Panel |
...
| [xquik](../skills/analytics/sources/xquik/) | Public X data research, monitoring, and evidence collection |
...
### 3.1 SEO Foundation (Technical → On-Page → Content → Off-Page)
...
```
                    ...
                    │  indexnow · crawlability · core-web-vitals · mobile-friendly · rendering-strategies │
                    └─────────────────────┬────────────────────┘
                                          │
         ┌────────────────────────────────┼────────────────────────────────┐
         ▼                                ▼                                ▼
...
│ image · video    │           │ eeat-signals ·      │
│ url-structure ·   │           │ competitor-research │
│ heading          │           └──────────────────────┘
└──────────────────┘
```

### 3.2 SERP & Rich Results
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│  Channels · Platforms · Strategies                                          │
│  affiliate · email · egc · influencer · referral · x · reddit · linkedin ·   │
│  branding · seo-strategy · paid-ads · cold-start · geo · parasite · programmatic│
└─────────────────────────────────────────────────────────────────────────────┘
```

### 3.5 Components & Analytics
...
**Skill uniqueness**: Each skill keeps only topic-relevant content. Overlapping topics use **Related Skills** references. See [skill-authoring §4](skill-authoring.md#4-body-content-markdown-body).
