---
name: pr-marketing
description: When the user wants to plan PR, write a press release, or manage media relations. Also use when the user mentions "PR," "press release," "media relations," "news release," "journalist," "media coverage," "product announcement," or "earned media."
metadata:
  version: 1.0.0
---
