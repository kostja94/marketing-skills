...
|------|----------------|-------------------|
| **Security** (SSL, Norton, McAfee) | Checkout, payment forms | +15–30% for unfamiliar brands |
| **Payment logos** (Visa, PayPal, Stripe) | Checkout, cart | +8–12% trust |
| **Money-back guarantee** | Product, checkout | +6–10% |
| **Reviews/ratings** (Trustpilot, BBB) | Product, hero | +12–18% |
...
- **3–4 badge types max**; more can cause "badge bloat" and reduce conversions by 5–8%
