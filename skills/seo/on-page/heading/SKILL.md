...
description: "Optimize heading structure (H1-H6) for SEO and content clarity. Use when: heading hierarchy, H1 tag, H2, H3, heading tags, heading SEO, multiple H1, content structure, fix headings."
metadata:
  version: 1.0.0
---
